...
parser.add_argument('--miniou',type=float,default=0.5)
args = parser.parse_args()
MINOVERLAP = args.miniou
'''
    0,0 ------> x (width)
     |
     |  (Left,Top)
...
surfix =args.surfix
GT_PATH = os.path.join(os.getcwd(), 'inputWav', 'ground-truth_'+surfix)
DR_PATH = os.path.join(os.getcwd(), 'inputWav', 'detection-results_'+surfix)
IMG_PATH = os.path.join(os.getcwd(), 'inputWav', 'images-optional')
