from tools.get_dr_txtWav import *
from tools.get_gt_txtWav import *
import subprocess
import argparse
...
if not os.path.exists("./inputWav"):
    os.makedirs("./inputWav")
if not os.path.exists("./inputWav/detection-results_"+surfix):
    os.makedirs("./inputWav/detection-results_"+surfix)
if not os.path.exists("./inputWav/images-optional"):
    os.makedirs("./inputWav/images-optional")

for image_id in tqdm(image_ids):
    image_path = f"./VOCdevkit/VOC{args.year}/JPEGImages/" + image_id + ".jpg"
    image = Image.open(image_path)
    # image.save("./inputWav/images-optional/"+image_id+".jpg")
    centernet.detect_image(image_id, image ,"./inputWav/detection-results_"+surfix)
...
if not os.path.exists("./inputWav"):
    os.makedirs("./inputWav")
if not os.path.exists("./inputWav/ground-truth_"+surfix):
    os.makedirs("./inputWav/ground-truth_"+surfix)

for image_id in image_ids:
    with open("./inputWav/ground-truth_"+surfix+"/"+image_id+".txt", "w") as new_f:
...
subprocess.run('python tools/get_mapWav.py --surfix '+str(surfix))